...
> = {
  ...
  success: {
    surface: "border-feedback-success bg-background-default",
    tone: "text-feedback-success",
    title: "Changes saved",
    icon: CircleCheck,
  },
  error: {
    surface: "border-feedback-danger bg-background-default",
    tone: "text-feedback-danger",
    title: "Could not save changes",
    icon: CircleX,
  },
  warning: {
    surface: "border-feedback-warning bg-background-default",
    tone: "text-feedback-warning",
    title: "Your trial ends in 3 days",
    icon: TriangleAlert,
  },
  info: {
    surface: "border-feedback-info bg-background-default",
