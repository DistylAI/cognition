...
>(
  (
    ...
    const { isMobile, mobileReturnFocusRef, mobileTriggerRef, state, openMobile, setOpenMobile } =
      useSidebar();
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile='true'
            className='w-[--sidebar-width] max-w-full overflow-x-hidden bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden'
            style={{ '--sidebar-width': SIDEBAR_WIDTH_MOBILE } as React.CSSProperties}
            side={side}
            onCloseAutoFocus={event => {
              const returnFocus = mobileReturnFocusRef.current?.isConnected
          ...
          >
            ...
            <SheetDescription className='sr-only'>Browse available applications.</SheetDescription>
