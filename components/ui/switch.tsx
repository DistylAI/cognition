...
// (h-[1.15rem] w-8, single border), shadow-sm, the v4 focus ring, and the
// calc-based thumb travel. bg-primary / bg-input / bg-background / ring stay
// mapped to Folio v1.2 tokens, so track and thumb theme via
