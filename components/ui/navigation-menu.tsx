...
// NavigationMenu set). The raw bg-background / bg-accent / bg-popover / border
// colors are mapped to Cognition tokens so it themes via [data-theme="dark"]
